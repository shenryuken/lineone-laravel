<x-app-layout-sideblock title="Notification Settings" is-header-blur="true">
<div class="py-5">
            ...
            <main class="main-content w-full px-[var(--margin-x)] pb-8">
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="space-y-6">
                        <!-- Email Notifications -->
                        <div>
                            <h3 class="text-base font-medium text-slate-700 dark:text-navy-100 mb-3">Email Notifications</h3>
                            <div class="space-y-3">
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Transaction confirmations</span>
                                ...
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Security alerts</span>
                                    <input type="checkbox" checked class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Account updates</span>
                                ...
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Marketing emails</span>
                                    <input type="checkbox" class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- SMS Notifications -->
                        <div>
                            <h3 class="text-base font-medium text-slate-700 dark:text-navy-100 mb-3">SMS Notifications</h3>
                            <div class="space-y-3">
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Transaction alerts</span>
                                    <input type="checkbox" checked class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Security codes</span>
                                    <input type="checkbox" checked class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Account alerts</span>
                                    <input type="checkbox" class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- Push Notifications -->
                        <div>
                            <h3 class="text-base font-medium text-slate-700 dark:text-navy-100 mb-3">Push Notifications</h3>
                            <div class="space-y-3">
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Real-time transactions</span>
                                    <input type="checkbox" checked class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Payment reminders</span>
                                    <input type="checkbox" class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                                <label class="inline-flex items-center justify-between w-full">
                                    <span class="text-slate-600 dark:text-navy-200">Promotional offers</span>
                                    <input type="checkbox" class="form-checkbox is-basic h-5 w-5 rounded border-slate-400/70 checked:bg-primary checked:border-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent">
                                </label>
                            </div>
                        </div>
