<x-app-layout-sideblock title="Transaction History" is-header-blur="true">
<div class="py-5">
            ...
            <div class="w-full lg:flex-1">
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="{{ route('settings.profile') }}" class="card p-4 border border-slate-200 dark:border-navy-500 hover:bg-slate-50 dark:hover:bg-navy-600 transition-colors">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                </div>
                                <div>
                                    <h3 class="font-medium text-slate-700 dark:text-navy-100">Profile Settings</h3>
                                    <p class="text-xs+ text-slate-400 dark:text-navy-300 mt-1">Update your personal information</p>
                                </div>
                            </div>
                        </a>
                        
                        <a href="{{ route('settings.security') }}" class="card p-4 border border-slate-200 dark:border-navy-500 hover:bg-slate-50 dark:hover:bg-navy-600 transition-colors">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                ...
                                <div>
                                    <h3 class="font-medium text-slate-700 dark:text-navy-100">Security</h3>
                                    <p class="text-xs+ text-slate-400 dark:text-navy-300 mt-1">Manage password and security settings</p>
                                </div>
                            </div>
                        </a>
                        
                        <a href="{{ route('settings.notifications') }}" class="card p-4 border border-slate-200 dark:border-navy-500 hover:bg-slate-50 dark:hover:bg-navy-600 transition-colors">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                                ...
                                <div>
                                    ...
                                    <p class="text-xs+ text-slate-400 dark:text-navy-300 mt-1">Configure how you receive notifications</p>
                                </div>
                            </div>
                        </a>
                        
                        <a href="{{ route('settings.limits') }}" class="card p-4 border border-slate-200 dark:border-navy-500 hover:bg-slate-50 dark:hover:bg-navy-600 transition-colors">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                ...
                                <div>
                                    <h3 class="font-medium text-slate-700 dark:text-navy-100">Transfer Limits</h3>
                                    <p class="text-xs+ text-slate-400 dark:text-navy-300 mt-1">Manage your daily and monthly transfer limits</p>
                                </div>
                            </div>
                        </a>
                    </div>
