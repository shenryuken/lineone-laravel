    ...
    <div class="mt-4 grid grid-cols-12 gap-4 bg-slate-150 py-5 dark:bg-navy-800 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
        ...
        <div
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 1'" class="size-6" src="{{ asset('images/awards/award-1.svg') }}"
                            alt="avatar" />
                        <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('images/awards/award-6.svg') }}"
                            alt="avatar" />
                        <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('images/awards/award-9.svg') }}"
                            alt="avatar" />
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('images/awards/award-14.svg') }}"
                            alt="avatar" />
                        <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('images/awards/award-13.svg') }}"
                            alt="avatar" />
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('images/awards/award-15.svg') }}"
                            alt="avatar" />
                        <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('images/awards/award-13.svg') }}"
                            alt="avatar" />
                    </div>
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        ...
                        <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('images/awards/award-5.svg') }}"
                            alt="avatar" />
                        <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('images/awards/award-25.svg') }}"
                            alt="avatar" />
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('images/awards/award-1.svg') }}"
                            alt="avatar" />
                        <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('images/awards/award-24.svg') }}"
                            alt="avatar" />
                        <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('images/awards/award-30.svg') }}"
                            alt="avatar" />
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
        ...
        <div class="card col-span-12 sm:col-span-6">
            ...
            <div class="grid grid-cols-1 gap-4 px-4 sm:gap-5 sm:px-5 lg:grid-cols-2">
                ...
                <div class="rounded-lg border border-slate-150 p-4 dark:border-navy-600">
                    ...
                    <div class="progress mt-3 h-1.5 bg-slate-150 dark:bg-navy-500">
                        <div class="is-active relative w-4/12 overflow-hidden rounded-full bg-slate-500 dark:bg-navy-400">
                        </div>
                    </div>
                    <div class="mt-2 flex justify-between text-xs text-slate-400 dark:text-navy-300">
                        <p>Monthly target</p>
