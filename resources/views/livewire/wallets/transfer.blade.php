{{-- <div>
    ...
    <div class="p-4">
            ...
            <div class="mb-4">
                ...
                <select wire:model="source_wallet_id"
                    ...
                    <option value="{{ $wallet->id }}">
                        {{ $wallet->currency }} Wallet ({{ $wallet->account_number}})
                    </option>
                    @endforeach
                </select>
        ...
        <div>
            <h3 class="text-lg font-medium text-slate-700 dark:text-navy-100 mb-4">Confirm Transfer</h3>
            ...
            <div class="rounded-lg bg-slate-100 p-4 dark:bg-navy-600 mb-4">
                ...
                <div class="flex justify-between mb-2">
                    <span class="text-slate-500 dark:text-navy-200">To:</span>
                    <span class="font-medium">{{ $recipient ? $recipient->name : '' }}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span class="text-slate-500 dark:text-navy-200">Account:</span>
        ...
        <div class="text-center">
            ...
            <h3 class="text-lg font-medium text-slate-700 dark:text-navy-100 mb-2">Transfer Successful!</h3>
            <p class="text-slate-500 dark:text-navy-200 mb-4">Your funds have been successfully transferred.</p>
