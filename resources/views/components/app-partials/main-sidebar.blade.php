    ...
    <div
        ...
        <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
            ...
            <a href="{{ route('admin.users.index') }}"
                ...
                <svg class="size-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM6 8a6 6 0 1 1 12 0A6 6 0 0 1 6 8z" />
                    <path fill="currentColor" fill-opacity=".3"
                        d="M5.5 20c-.83 0-1.5-.67-1.5-1.5v-1c0-1.97 1.93-3.5 4-3.5h8c2.07 0 4 1.53 4 3.5v1c0 .83-.67 1.5-1.5 1.5h-13z" />
                    <path fill="currentColor"
                        d="M16 14.5c-1.38 0-2.5.9-2.5 2v1h5v-1c0-1.1-1.12-2-2.5-2zm-8 0C6.62 14.5 5.5 15.4 5.5 16.5v1h5v-1c0-1.1-1.12-2-2.5-2z" />
                </svg>
            </a>
            @endrole
